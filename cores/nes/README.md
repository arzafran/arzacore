...
You can load external palettes as well. This palette is stored at `Assets/nes/arzacore.NES/custom.pal`, and can be selected by the sixth option (`Custom`).
...
arzacore-NES is a rebuild of agg23/openFPGA-NES, a Pocket port of the MiSTer NES core (Ludvig Strigeus, sorgelig, Kitrinx, paulb-nl, greyrogue, et al.). Licensed GPL-3.0. Source: https://github.com/arzafran/arzacore-NES

Installs as `arzacore.NES`; fresh build, does not import saves from agg23.NES.
