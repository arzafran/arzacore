...
arzacore-SNES is a rebuild of [agg23/openfpga-snes](https://github.com/agg23/openfpga-snes), a Pocket port of the MiSTer SNES core (srg320 and the MiSTer-devel contributors). Licensed GPL-3.0. Source: https://github.com/arzafran/arzacore-SNES

This is a fresh build — it installs as `arzacore.SNES` and does not share a save directory with any previous `agg23.SNES` installation; saves are not automatically imported.