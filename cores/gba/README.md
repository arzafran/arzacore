# GBA for Analogue Pocket (arzacore build)

[![Latest Release](https://img.shields.io/github/v/tag/arzafran/arzacore-GBA?label=latest)](https://github.com/arzafran/arzacore-GBA/releases/latest) [![Downloads](https://img.shields.io/github/downloads/arzafran/arzacore-GBA/total)](https://github.com/arzafran/arzacore-GBA/releases) [![Platform](https://img.shields.io/badge/platform-Analogue%20Pocket-blue)](https://openfpga-library.github.io/analogue-pocket/)
...
### **WARNING: Forced RTC setting persists across games! Remember to turn it off before loading a game that doesn't need it**
### **WARNING: Do not enable this setting unless you are playing a romhack that needs it**
...
The core installs as `arzacore.GBA` — this is a fresh build from source and saves from `mincer_ray.GBA` are not automatically imported.
...
arzacore-GBA is a rebuild of [mincer-ray/openfpga-GBA](https://github.com/mincer-ray/openfpga-GBA), a Pocket port of the MiSTer GBA core ([GBA_MiSTer](https://github.com/MiSTer-devel/GBA_MiSTer), Robert Peip/FPGAzumSpass and MiSTer-devel contributors). Licensed GPL-2.0. Source: https://github.com/arzafran/arzacore-GBA
