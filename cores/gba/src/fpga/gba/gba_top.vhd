...
entity gba_top is
   ...
   (
      ...
      MaxPakAddr            : in     std_logic_vector(24 downto 0); -- max byte address that will contain data, required for buggy games that read behind their own memory
      ...
      savestate_busy        : out    std_logic;                     -- high while save/load in progress
      sleep_external        : in     std_logic := '0';              -- external pause (Phase 1 staging)
